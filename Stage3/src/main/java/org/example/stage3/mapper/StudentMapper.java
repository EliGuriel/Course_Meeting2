...
public class StudentMapper {
    ...
    public Student toEntity(StudentDto dto) {
        ...
        // Note: We don't set teacher here as it needs to be loaded from the repository
    ...
    public StudentDto toDto(Student entity) {
        ...
        // map Teacher to TeacherBasicDto if exists
        if (entity.getTeacher() != null) {
            dto.setTeacher(teacherMapper.toBasicDto(entity.getTeacher()));
        }
    ...
    public void updateEntityFromDto(Student entity, StudentDto dto) {
        ...
        // Note: We don't update teacher here as it needs to be loaded from the repository
        // That will be handled in the service layer
    }
