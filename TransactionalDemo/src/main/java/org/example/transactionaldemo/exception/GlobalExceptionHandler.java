...
public class GlobalExceptionHandler {
    ...
    /**
     * Takes care of RollingBackException, 400 Bad Request
     */
    ...
    /**
     * Takes care of ResourceNotFoundException, 404 Not Found
     */
    @ExceptionHandler(ResourceNotFoundException.class)
    public ResponseEntity<StandardResponse> handleResourceNotFound(ResourceNotFoundException ex, WebRequest request) {
        Map<String, String> details = new HashMap<>();
    ...
    /**
     * Takes care of ResourceAlreadyExistsException, 409 Conflict
     */
    @ExceptionHandler(ResourceAlreadyExistsException.class)
    public ResponseEntity<StandardResponse> handleResourceAlreadyExists(ResourceAlreadyExistsException ex, WebRequest request) {
        Map<String, String> details = new HashMap<>();
    ...
    public ResponseEntity<StandardResponse> handleIdMismatch(IdMismatchException ex, WebRequest request) {
        Map<String, String> details = new HashMap<>();
    ...
    /**
     * Takes care of InvalidRequestException, 400 Bad Request
     */
    ...
    /**
     * Exception handler for constraint violations in service layer
     */
    @ExceptionHandler(ConstraintViolationException.class)
    public ResponseEntity<StandardResponse> handleConstraintViolation(ConstraintViolationException ex, WebRequest request) {
        Map<String, String> errors = new HashMap<>();
        ...
        Map<String, Object> details = new HashMap<>();
        details.put("type", "Validation Failed");
        details.put("constraints", errors);
    ...
    public ResponseEntity<StandardResponse> handleHttpMessageNotReadable(HttpMessageNotReadableException ex, WebRequest request) {
        Map<String, String> details = new HashMap<>();
        details.put("type", "Malformed JSON Request");
        details.put("message", "The request body could not be parsed: " + ex.getMessage());
